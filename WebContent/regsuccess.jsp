...
.lt-ie9 {
  input[type=text], input[type=password],input[type=email] { line-height: 34px; }
}</style>
  <meta charset="utf-8">
...
<%!String url = "jdbc:mysql://localhost:3306/techtalk";%>
<%!String user = "root";%>
<%!String psw = "root";%>
<%
Connection con = null;
...
%>
  <section class="container">
    <div class="login">
      <h1>New Registration For Techtalk</h1>
      <form method="post" action="EventRegister">
        <p><input type="text" name="empid" value="" placeholder="Employee ID" required="required"></p>
        <p><input type="text" name="empname" value="" placeholder="Employee Name" required="required"></p>
       <p><input type="text" name="eventname" value="" placeholder="Event Name" required="required"></p> 
        <!--  <p>Select Event :
<select>
<%
while(rs.next())
